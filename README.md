...
Aquest repositori conté l'aplicació mòbil desenvolupada amb **React Native**.
...
- Si ja el tens instal·lat i no et funciona, assegura't que les rutes de Python estiguin al capdamunt de les teves _Variables d'Entorn_.
